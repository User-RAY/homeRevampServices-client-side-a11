...
<div className="min-h-screen flex flex-col justify-center items-center w-11/12 mx-auto my">
                ...
                <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                    <form className="card-body text-black pb-0">
                    ...
                    <div className="px-4">
                        ...
                        <button className="btn max-w-sm w-full bg-black text-white mb-4 shadow-2xl"> <FcGoogle className="text-xl" />Login with Google</button>
                    </div>
